...
def hit(x, y, head_center):
    ...
    if(hit_criteria >= distanceheadball):# IF this is a hit, then proceed to implement velocity functions
        ...
        _, _, xvelocity = velocityx(ball.x_position,head_center,xvelocity)#Determining the x and y velocities of the ball
        _, _, yvelocity = velocityy(ball.y_position,head_center,yvelocity)
...
while(cap.isOpened()):
    ...
    if ret==True:
        ...
        for (topleft_x,topleft_y,head_width,head_height) in faces:
            ...
            cv2.circle(frame, (center_x,center_y), (int(head_radius)), (random.randint(0,250),random.randint(0,250),random.randint(0,250)), 2)#radius must be changed for different computers/different screens
        ...
        cv2.circle(frame,(int(ball.x_position),int(ball.y_position)), 25, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        #Little black circles
        cv2.circle(frame,(int(ball.x_position) + 5,int(ball.y_position) + 5), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) + 5,int(ball.y_position) - 5), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) - 5,int(ball.y_position) + 5), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) - 5,int(ball.y_position) - 5), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) + 5,int(ball.y_position) + 5), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) + 10,int(ball.y_position) + 10), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) + 10,int(ball.y_position) - 10), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) - 10,int(ball.y_position) + 10), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) - 10,int(ball.y_position) - 10), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        cv2.circle(frame,(int(ball.x_position) + 10,int(ball.y_position) + 10), 5, (random.randint(0,250),random.randint(0,250),random.randint(0,250)), -1)
        ...
        cv2.rectangle(frame,(40,50),(100,height-300),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),3)
        cv2.putText(frame,text1,(60,height-400), font, 0.5,(random.randint(0,250),random.randint(0,250),random.randint(0,250)),2,cv2.LINE_AA)
        
        cv2.rectangle(frame,(width-100,50),(width-40,height-300),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),3)
        cv2.putText(frame,text2,(width-90,height-400), font, 0.5,(random.randint(0,250),random.randint(0,250),random.randint(0,250)),2,cv2.LINE_AA)
        
        cv2.line(frame,(40,0),(40,height),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),20)
        cv2.line(frame,(width-40,0),(width-40,height),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),20)
        cv2.line(frame,(0,height),(width,height),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),40)
        
        if ((z1-z2) >= 2 and z1 >= targetScore):
            cv2.rectangle(frame,(150,100),(width-150,int(height/2)),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),3)
            cv2.putText(frame, "K Wins!",(150,int(height/2) - 50), font, 3,(random.randint(0,250),random.randint(0,250),random.randint(0,250)),2,cv2.LINE_AA)#str(Player_1.name," Wins!"),(150,180), font, 3,(255,0,255),2,cv2.LINE_AA)
            ball.x_position, ball.y_position, xvelocity, yvelocity = reset_to_center()
        if ((z2-z1) >= 2 and z2 >= targetScore):
            cv2.rectangle(frame,(150,100),(width-150,int(height/2)),(random.randint(0,250),random.randint(0,250),random.randint(0,250)),3)
            cv2.putText(frame, "J Wins!",(150,int(height/2) - 50), font, 3,(random.randint(0,250),random.randint(0,250),random.randint(0,250)),2,cv2.LINE_AA)#str(Player_2.name," Wins!"),(150,180), font, 3,(0,255,0),2,cv2.LINE_AA)
            ball.x_position, ball.y_position, xvelocity, yvelocity = reset_to_center()       
