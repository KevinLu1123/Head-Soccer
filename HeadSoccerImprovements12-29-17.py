 ...
 #           self.prev_x = 0                       Should be the same case for headvelocity_x, which is perhaps why xvelocity does not change or changes once from an initial value, and why yvelocity stays 0.
  #          self.prev_y = 0
    ...
    def hitresult(self,b,xvelocity,yvelocity):   
        ...
        return(slope,ball.x_position,ball.y_position,xvelocity,yvelocity,headvelocity_x,headvelocity_y)
...
def xUpdate(P,xvelocity,yvelocity):
    if P != None:
        _, ball.x_position, _, xvelocity, _, headvelocity_x, _ = P.hitresult(ball,xvelocity,yvelocity)#call function for if head hits ball
...
def yUpdate(safetybouncecount,P,xvelocity,yvelocity,headvelocity_y):
    if P != None:
        _, _, ball.y_position, _, yvelocity, _, headvelocity_y = P.hitresult(ball,xvelocity,yvelocity)
    print("Ball velocity x: ", xvelocity)
    print("Ball velocity y: ", yvelocity)
    return(ball.y_position, yvelocity, headvelocity_y)
    
def final_yvelocity(yvelocity,safetybouncecount):
    ygravity = 2
...
while(cap.isOpened()):
    ...
    if ret==True:
        ...
        if Player_1.hit(x,y):
            ...
            print("Ball velocity x: ", xvelocity)
            print("Ball velocity y: ", yvelocity)
            ball.x_position,xvelocity,x = final_xvelocity(xvelocity)
            print("Ball velocity x: ", xvelocity)
            print("Ball velocity y: ", yvelocity)
            ...
            ball.y_position, safetybouncecount,yvelocity,y = final_yvelocity(yvelocity,safetybouncecount)
            ...
            print("Ball velocity x: ", xvelocity)
            print("Ball velocity y: ", yvelocity)
            ball.y_position, yvelocity, headvelocity_y = yUpdate(safetybouncecount,None,xvelocity,yvelocity,headvelocity_y)
            ball.y_position, safetybouncecount,yvelocity,y = final_yvelocity(yvelocity,safetybouncecount)
